...
INSERT INTO query_tools.explore_query_results(
        query_id, query_name, user_id, query_status, clear_result_set_size, clear_result_set, query_definition, i2b2_encrypted_patient_set_id, i2b2_non_encrypte_patient_set_id)
