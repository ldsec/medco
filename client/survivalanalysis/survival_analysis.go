...
func NewSurvivalAnalysis(token string, patientSetID int, subGroupDefinitions []*survival_analysis.SubGroupDefinitionsItems0, limit int, granularity, startConcept, startModifier, endConcept, endModifier string, disableTLSCheck bool) (q *SurvivalAnalysis, err error) {
	q = &SurvivalAnalysis{
		authToken:           token,
