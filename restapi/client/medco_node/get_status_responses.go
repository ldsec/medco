...
func (o *GetStatusOK) Error() string {
	return fmt.Sprintf("[GET /node/status][%d] getStatusOK  %+v", 200, o.Payload)
}
...
func (o *GetStatusDefault) Error() string {
	return fmt.Sprintf("[GET /node/status][%d] getStatus default  %+v", o._statusCode, o.Payload)
}

func (o *GetStatusDefault) GetPayload() *GetStatusDefaultBody {
	return o.Payload
}
...
func (o *GetStatusDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(GetStatusDefaultBody)
