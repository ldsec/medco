...
func (o *QueryOK) GetPayload() *models.QueryStatus {
	return o.Payload
}
...
func (o *QueryDefault) Error() string {
	return fmt.Sprintf("[POST /query][%d] query default  %+v", o._statusCode, o.Payload)
}

func (o *QueryDefault) GetPayload() *QueryDefaultBody {
	return o.Payload
}
