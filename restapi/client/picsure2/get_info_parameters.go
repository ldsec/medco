...
// WithBody adds the body to the get info params
func (o *GetInfoParams) WithBody(body GetInfoBody) *GetInfoParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get info params
func (o *GetInfoParams) SetBody(body GetInfoBody) {
	o.Body = body
}
