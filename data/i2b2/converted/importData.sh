...
CREATE TABLE shrine_ont.icd10_icd9 AS SELECT * FROM i2b2metadata.icd10_icd9 WHERE 1=2;
...
\copy shrine_ont.icd10_icd9 FROM 'shrine_icd10_icd9.csv' ESCAPE '"' DELIMITER ',' CSV HEADER;
...
\copy i2b2metadata.icd10_icd9 FROM 'local_icd10_icd9.csv' ESCAPE '"' DELIMITER ',' CSV HEADER;
