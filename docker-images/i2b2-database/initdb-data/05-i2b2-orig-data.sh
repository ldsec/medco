...
function loadI2b2Data {
    ...
    cat > db.properties <<EOL
        ...
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2demodata
        db.project=demo
EOL
...
EOL
    ...
    cat > db.properties <<EOL
        ...
        db.password=$DB_PASSWORD
        db.driver=org.postgresql.Driver
        db.url=jdbc:postgresql://localhost/$DB_NAME?searchpath=i2b2metadata
        db.project=demo
EOL
...
loadI2b2Data $I2B2_MEDCO_DB_NAME true
