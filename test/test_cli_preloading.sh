...
USERNAME=${1:-test}
test5 "day" "observations" "${survivalDays}"
test5 "week" "observations" "${survivalWeeks}"
test5 "month" "observations" "${survivalMonths}"
test5 "year" "observations" "${survivalYears}"
test5 "day" "encounters" "${survivalDays}"
