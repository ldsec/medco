...
if [[ "$DATASET" = "genomic_orig" ]]; then
  ...
  wget -O ${SCRIPT_FOLDER}/spo-synthetic/PATIENT_MAPPING.csv ${REPO_URL}/spo-synthetic/PATIENT_MAPPING.csv?raw=true
  wget -O ${SCRIPT_FOLDER}/spo-synthetic/ENCOUNTER_MAPPING.csv ${REPO_URL}/spo-synthetic/ENCOUNTER_MAPPING.csv?raw=true
