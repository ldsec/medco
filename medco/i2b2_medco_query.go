...
// handle i2b2MedCo query
func I2b2MedCoQuery(query *models.QueryI2b2Medco) (result *models.QueryResultElement, err error) {
	// todo: timers
	...
	queryName := "MedCo query (" + time.Now().Format(time.RFC3339Nano) + ")"
