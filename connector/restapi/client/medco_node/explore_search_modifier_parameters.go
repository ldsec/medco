...
/* ExploreSearchModifierParams contains all the parameters to send to the API endpoint
   for the explore search modifier operation.
...
// WithDefaults hydrates default values in the explore search modifier params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExploreSearchModifierParams) WithDefaults() *ExploreSearchModifierParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the explore search modifier params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ExploreSearchModifierParams) SetDefaults() {
