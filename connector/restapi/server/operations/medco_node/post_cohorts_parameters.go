...
// PostCohortsParams contains all the bound params for the post cohorts operation
// typically these are obtained from a http.Request
//
// swagger:parameters postCohorts
...
//
// To ensure default values, the struct must have been initialized with NewPostCohortsParams() beforehand.
func (o *PostCohortsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
